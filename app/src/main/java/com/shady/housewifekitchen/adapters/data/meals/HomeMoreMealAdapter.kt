...
class HomeMoreMealAdapter (private val context: Context?) : RecyclerView.Adapter<HomeMoreMealAdapter.ViewHolder>() {

    var selected = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_more_meals, parent, false)
