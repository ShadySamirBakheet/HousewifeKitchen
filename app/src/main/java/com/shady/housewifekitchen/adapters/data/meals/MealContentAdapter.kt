...
class MealContentAdapter (private val context: Context?) : RecyclerView.Adapter<MealContentAdapter.ViewHolder>() {

    var selected = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_meal_content, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.apply {
            ...
            itemView.setOnClickListener {
                choose.setImageResource(R.drawable.done_mark)
            }
