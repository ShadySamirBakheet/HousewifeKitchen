...
class HomeLongMealAdapter (private val context: Context?) : RecyclerView.Adapter<HomeLongMealAdapter.ViewHolder>() {

    var selected = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_long_meals, parent, false)
