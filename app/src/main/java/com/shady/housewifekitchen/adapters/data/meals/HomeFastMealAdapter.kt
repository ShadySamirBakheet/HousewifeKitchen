...
class HomeFastMealAdapter  (private val context: Context?) : RecyclerView.Adapter<HomeFastMealAdapter.ViewHolder>() {

    var selected = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_fast_meals, parent, false)
