...
class ChefViewAdapter (private val context: Context?) : RecyclerView.Adapter<ChefViewAdapter.ViewHolder>() {

    var selected = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(context).inflate(R.layout.item_chef_view, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.apply {
            ...
            itemView.setOnClickListener {
                context?.startActivity(Intent(context,ViewChefInfoActivity::class.java))
            }
        }
    }
